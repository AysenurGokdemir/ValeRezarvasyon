package com.example.valerezarvasyon.helper;
...
public class SharedPreferenceHelper {
    ...
    public static class Key {
        /**
         * Burada değişken tanımlarken değişkeni de isim içerisinde tanımlamayı unutma
         * Örneğin : String değişken için USER_NAME_STR
         * int için USER_AGE_INT gibi
         */
